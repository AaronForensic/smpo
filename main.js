...
$(function() {
  ...
  function set_settings() {
	...
	settings.condition_1_adjusted_likes = [12000, 14000,15000,35000,80000,300000,110000,150000,200000]; // 9
  ...
  // **Slide:** **Username**       
  // Note: alphanumeric usernames with spaces are accepted
  ...
  function init_task() {
    ...
    // Redirect, default after 360000ms = 360s = 6min
    setTimeout(function() {
